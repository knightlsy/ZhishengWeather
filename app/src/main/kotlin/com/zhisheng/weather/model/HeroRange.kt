...
object HeroTemps {
    ...
    // 高低温分界用的是城市当地时刻，不是手机系统时区。
    // 东京 21 点已经该看夜低，不能因为手机还在上海的 20 点就继续显示今天高/低。
    fun zoneOf(utcOffsetSeconds: Int?): ZoneId {
        if (utcOffsetSeconds == null) return ZoneId.systemDefault()
        return try {
