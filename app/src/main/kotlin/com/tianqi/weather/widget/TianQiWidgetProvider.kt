package com.tianqi.weather.widget
...
import com.tianqi.weather.MainActivity
import com.tianqi.weather.R
import com.tianqi.weather.data.WidgetCache
import com.tianqi.weather.data.WidgetSnapshot
import com.tianqi.weather.model.WeatherCondition
import com.tianqi.weather.model.conditionIconRes
...
open class TianQiWidgetProvider : AppWidgetProvider() {
    ...
    private fun temperatureTrendBitmap(hours: List<com.tianqi.weather.data.WidgetHour>, light: Boolean): Bitmap? {
    ...
    companion object {
        private const val TAG = "TianQiWidget"
        private const val ACTION_REFRESH = "com.tianqi.weather.widget.REFRESH"
        ...
        fun refreshAll(context: Context) {
            ...
            listOf(
                TianQiWidgetSmall::class.java,
                TianQiWidgetMedium::class.java,
                TianQiWidgetLarge::class.java,
                TianQiWidgetNano::class.java,
                TianQiWidgetTower::class.java,
            ).forEach { cls ->
...
class TianQiWidgetSmall : TianQiWidgetProvider() {
    override val forcedLayout = R.layout.widget_small
}

class TianQiWidgetMedium : TianQiWidgetProvider() {
    override val forcedLayout = R.layout.widget_medium
}

class TianQiWidgetLarge : TianQiWidgetProvider() {
    override val forcedLayout = R.layout.widget_large
}

class TianQiWidgetNano : TianQiWidgetProvider() {
    override val forcedLayout = R.layout.widget_nano
}

class TianQiWidgetTower : TianQiWidgetProvider() {
