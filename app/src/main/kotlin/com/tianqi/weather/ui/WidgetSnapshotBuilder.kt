...
import com.tianqi.weather.data.WidgetDay
import com.tianqi.weather.data.WidgetHour
import com.tianqi.weather.data.WidgetLifeTip
...
import com.tianqi.weather.widget.TianQiWidgetProvider
...
object WidgetSnapshotBuilder {
    ...
    suspend fun save(context: Context, city: City, data: WeatherData) {
        ...
        TianQiWidgetProvider.refreshAll(context)
    }
}
