...
fun CommunityGroupDialog(onClose: () -> Unit) {
    ...
    Dialog(
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .background(TianQiBg.copy(alpha = 0.86f))
                .safeDrawingPadding()
                .padding(12.dp),
            ...
            Column(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text("CHANNEL ID", style = MaterialTheme.typography.labelSmall, color = TianQiTextTertiary)
                        Text(
                            CommunityQqGroup,
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .background(TianQiBg)
                            .border(1.dp, TianQiCyan.copy(alpha = 0.72f), RectangleShape)
                            .padding(7.dp),
                        contentAlignment = Alignment.Center,
                    ) {
                        Image(
                ...
                Row(modifier = Modifier.fillMaxWidth()) {
                    Box(
                        ...
                        Text("[ 复制群号 ]", style = MaterialTheme.typography.labelLarge, color = TianQiMint)
                    }
                    Box(
                        modifier = Modifier
                            .weight(1f)
                            .background(TianQiCardBorder.copy(alpha = 0.16f))
                            .clickable(role = Role.Button, onClick = onClose)
                            .padding(vertical = 15.dp),
                        contentAlignment = Alignment.Center,
                    ) {
                        Text("[ 关闭 ]", style = MaterialTheme.typography.labelLarge, color = TianQiCyan)
                    }
                }
            }
        }
