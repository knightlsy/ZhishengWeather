        ...
        coroutineScope {
            ...
            val current = cur?.let {
                ...
                CurrentWeather(
                    ...
                    precipMm = it.precipitation?.let { mm ->
                        ...
                        com.tianqi.weather.model.Nowcast.accumulatedMmToRate(mm.toFloat(), periodMin).toDouble()
                    },
                    profile = profile,
                )
            }
            ...
            val daily = m.daily?.let { d ->
                d.time?.mapIndexedNotNull { i, day ->
                    ...
                    MoonCalc.enrich(
                        com.tianqi.weather.model.DailyWeather(
                            dateMillis = e,
            ...
            val precip = m.minutely_15?.let { mm ->
                mm.time?.mapIndexedNotNull { i, t ->
                    ...
                    else MinutePrecip(e, com.tianqi.weather.model.Nowcast.accumulatedMmToRate(
