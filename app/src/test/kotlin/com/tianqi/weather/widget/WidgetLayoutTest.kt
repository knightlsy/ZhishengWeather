...
class WidgetLayoutTest {
    ...
    fun compactWidgetsAlwaysReserveAWeightedReadableCityLine() {
        ...
        val source = sequenceOf(
            File("app/src/main/kotlin/com/tianqi/weather/widget/TianQiWidgetProvider.kt"),
            File("src/main/kotlin/com/tianqi/weather/widget/TianQiWidgetProvider.kt"),
        ).first { it.isFile }.readText()
    ...
    fun largeWidgetCanRenderSevenDatedForecastRows() {
        ...
        val builder = sequenceOf(
            File("app/src/main/kotlin/com/tianqi/weather/ui/WidgetSnapshotBuilder.kt"),
            File("src/main/kotlin/com/tianqi/weather/ui/WidgetSnapshotBuilder.kt"),
        ).first { it.isFile }.readText()
    ...
    fun largeWidgetUsesItsMiddleForRealComplicationsAndActions() {
        ...
        val provider = File(
            root,
            "kotlin/com/tianqi/weather/widget/TianQiWidgetProvider.kt",
        ).readText()
    ...
    fun widgetFamilyHasFiveHardwareFormFactorsAndOneLightIconTone() {
        ...
        listOf("Small", "Medium", "Large", "Nano", "Tower").forEach { size ->
            assertTrue("Missing $size widget provider", manifest.contains("TianQiWidget$size"))
        }
